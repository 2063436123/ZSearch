...
bool compareLessEqual(const Value& v1, const Value& v2)
{
    return v1 <= v2;
}
...
bool compareGreaterEqual(const Value& v1, const Value& v2)
{
    return v1 >= v2;
}
...
bool compareIn(const Value& v1, const Value& v2)
{
    ...
    switch (v1.getValueType())
    {
        ...
        case ValueType::Bool:
            THROW(Poco::NotImplementedException()); // 未实现是因为 doArrayHandler 不支持 bool
